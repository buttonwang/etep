...
function doCheck(){
	if (${formulatorTest} && checkAmbowPlugin() ) {
		 doit(sign02);
		 doit(sign01);
		 //doit(sign13);
		 return 1;
	...
	if (${formulatorTest} && (checkAmbowPlugin()==0) ) {
		doit(formulator_test_1);
		doit(formulator_test_2);
		doit(formulator_button);
		return 1;
	}
...
<!--
/* wangwei Add begin*/
sub {margin:0 3px;*display: table-cell; vertical-align:middle; padding:1px; float:none;}
...
<script type="text/javascript" src="../js/exam.js"></script>
 <!--stars div2-->
<div class="floatBoxs" id=sign02  style='z-index:20;display:xxx;'>
		<h3>输入练习</h3>
		<div class="floatBox">
		<div class="title_h1 cOra">热烈欢迎！正式学习前请先练习输入填空题答案！</div>		
		<div id="formulator_test_1" class="lianxi_ts" style="display:none">还没有安装数理化学习环境！    <a class="cOra" href="../../download/ambow_ete_setup.exe"><img src="../images/down_ico.gif" width="14" height="16" align="absmiddle" />下载安装</a> &nbsp;&nbsp;&nbsp;<a class="cOra" href="mainPage!mpc.jhtml">检查是否安装成功</a></div>
		<div class="content box1" id="formulator_test_2"  style="display:none">
		<ul>
			<li>注：部分试题答案包含公式答案，需用公式编辑器录入，如果你看到<img src="../images/shuru.gif" width="88" height="25" border="0" align="absmiddle" /><!-- span class='formulaInput' name='mathSpan' v='' 	onmouseover=showblock(this); onmouseout=hideblock(this); onclick=getMathInput(this);>点击输入公式</span--> ，请点击它，在弹出的编辑器中输入答案。</li>
		</ul>
		</div>
		<div id="formulator_button" style="display:xxx">
		<table width="70%" border="0" style="margin:auto">
          <tr>
            <td width="50%" align="center">
            	<div class="lianxi1" onmouseout="this.className='lianxi1';" onmouseover="this.className='lianxi2';">
            ...
            <td width="50%" align="center">
            	<div class="tg1" onmouseout="this.className='tg1';" onmouseover="this.className='tg2';">
            		<a href="javascript:void(null)" onclick="javascript:updateFormulatorTest();">
            			<span>跳过</span>
            		</a>
            	</div>
            </td>
        ...
        <!--stars div3-->
		<div class="floatBoxs" id=sign03  style='z-index:30;display:none;' > 
		<h3>填空练习</h3>
		<div class="floatBox">
		<div class="title_h1 cOra">第1题</div>
		<div class="content box1">
		<P>杆AC受的是<input class="input_text2 " id="question_1_input_1" name="test" type="text" />(“压力“或是“拉力”)，
		BC上受的是<input class="input_text2 " id="question_1_input_2" name="test" type="text" />(“压力“或是“拉力”)，
		受力大小分别是AC<input class="input_text2 " id="question_1_input_3" name="test" type="text" />N，
        ...
        <!--stars div4-->
		<div class="floatBoxs" id=sign04  style='z-index:40;display:none;' > 
		<h3>填空练习</h3>
		<div class="floatBox">
		<div class="title_h1 cOra">第1题</div>
		<div class="content box1">
        ...
        <!--stars div5-->
        <div class="floatBoxs" id=sign05  style='z-index:50;display:none;' > 
		<h3>公式输入练习</h3>
		<div class="floatBox">
        ...
        <p><strong>方法1：</strong>按快捷键Ctrl+L(对应<img src="../images/image012.png" width="32" height="32" />)，输入H，按键盘上<img src="../images/right_jp.gif" width="50" height="28" />，输入2，再按<img src="../images/right_jp.gif" width="50" height="28" />，输入O。<span class="cOra">（<strong>推荐</strong>）</span></p><br />
        <div class="blank6"></div>
         <p> <strong>方法2：</strong>点
          ...
          <div class="blank6"></div>
         <p> <strong>方法3：</strong>输入H，选定H，点<img src="../images/image014.png" width="24" height="24" />选<img src="../images/image012.png" alt="" width="32" height="32" />，输入2，按键盘<img src="../images/right_jp.gif" alt="" width="50" height="28" />，输入O。</p> 
            <div class="clear"></div>
        </div>
		</div>
		<div class="btn">
		<span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign06);doit(sign05);doQuestion2();">提交</button></span>
         ...
         <!--stars div6-->
		<div class="floatBoxs" id=sign06  style='z-index:60;display:none;' > 
		<h3>填空练习</h3>
		<div class="floatBox">
		<div class="title_h1 cOra">第2题</div>
		<div class="content box1">
        ...
        <!--stars div7-->
        <div class="floatBoxs" id=sign07  style='z-index:70;display:none;' > 
		<h3>公式输入练习</h3>
		<div class="floatBox">
        ...
        <p><strong>方法1：</strong>输入y=，按快捷键Ctrl+H(对应<img src="../images/image019.png" width="32" height="32" />)，输入x，按键盘上<img src="../images/right_jp.gif" width="50" height="28" />，输入2，再按<img src="../images/right_jp.gif" width="50" height="28" />输入-3x+1。<span class="cOra">（<strong>推荐</strong>）</span></p>
        <div class="blank6"></div>
         <p> <strong>方法2：</strong>输入y=，点<img src="../images/image014.png" width="24" height="24" />选<img src="../images/image019.png" alt="" width="32" height="32" />，输入x，按键盘上<img src="../images/right_jp.gif" alt="" width="50" height="28" />，输入2，再按<img src="../images/right_jp.gif" alt="" width="50" height="28" />，输入-3x+1。</p> 
          <div class="blank6"></div>
         <p> <strong>方法3：</strong>输入y=x，选定x，点<img src="../images/image014.png" width="24" height="24" />选<img src="../images/image019.png" alt="" width="32" height="32" />，输入2，按键盘上<img src="../images/right_jp.gif" alt="" width="50" height="28" />，输入-3x+1。</p> 
            <div class="clear"></div>
        </div>
		</div>
		<div class="btn">
		<span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign08);doit(sign07);doQuestion3();">提交</button></span>
         ...
         <!--stars div8-->
		<div class="floatBoxs" id=sign08  style='z-index:80;display:none;' > 
		<h3>公式输入练习</h3>
		<div class="floatBox">
		<div class="title_h1 cOra">第3题</div>
		<div class="content box1">
		<P>此函数表达式为<span  class='input_text formula' id="question_3_answer_1"></span>
		  <span id="question_3_image_1"></span></P>
        <div class="blank6"></div>
         <p><strong>正确答案：</strong><img src="../images/img/image017.png"/></p>
        <div class="blank6"></div>
        ...
        <span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign07);doit(sign08)">重练</button></span>
         <div class="clear"></div>
          ...
          <!--End div-->
           ...
           <!--stars div9-->
        <div class="floatBoxs" id=sign09  style='z-index:90;display:none;' > 
		<h3>公式输入练习</h3>
		<div class="floatBox">
        ...
        <span class="ui-icon-info" style="float: left; margin-right: 0.3em;"/></span><strong>
		输入技巧：</strong>
        <p>上下标只限定左侧紧邻的<strong>那一个</strong>字符，如本题中的下标2仅限定“)”。输入大写M、小写g、英文左括号 (、大写O、大写H，按快捷键Ctrl+L，输入英文右括号)，按键盘上<img src="../images/right_jp.gif" width="50" height="28" />，输入2。</p>
            <div class="clear"></div>
        </div>
		</div>
		<div class="btn">
		<span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign10);doit(sign09);doQuestion4();">提交</button></span>
         ...
         <!--stars div10-->
		<div class="floatBoxs" id=sign10  style='z-index:100;display:none;' > 
		<h3>公式输入练习</h3>
		<div class="floatBox">
		<div class="title_h1 cOra">第4题</div>
		<div class="content box1">
		<P>此碱是<span  class='input_text formula' id="question_4_answer_1"></span>
		  <span id="question_4_image_1"></span></P>
        <div class="blank6"></div>
         <p><strong>正确答案：</strong><img src="../images/img/image022.png"/></p>
        <div class="blank6"></div>
        ...
        <span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign09);doit(sign10)">重练</button></span>
         <div class="clear"></div>
          ...
          <!--End div-->
             ...
             <!--stars div11-->
        <div class="floatBoxs" id=sign11  style='z-index:110;display:none;' > 
		<h3>公式输入练习</h3>
		<div class="floatBox">
		...
		<span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign12);doit(sign11);doQuestion5();">提交</button></span>
         ...
         <!--stars div12-->
		<div class="floatBoxs" id=sign12  style='z-index:120;display:none;' > 
		<h3>公式输入练习</h3>
		<div class="floatBox">
		<div class="title_h1 cOra">第5题</div>
		<div class="content box1">
		<P>这是一个<input id="question_5_answer_1" name="test" type="text" class="input_text2 " /><span id="question_5_image_1"></span>反应，实验现象为溶液逐渐变<input id="question_5_answer_2" name="test" type="text" class="input_text2 " /><span id="question_5_image_2"></span>，有此<input id="question_5_answer_3" name="test" type="text" class="input_text2 " /><span id="question_5_image_3"></span>气体逸出。化学反应方程式为<span  class='input_text formula' id="question_5_answer_4"></span>
		  <span id="question_5_image_4"></span></P>
        <div class="blank6"></div>
        <p><strong>正确答案：</strong>氧化还原；蓝；红棕色；<img src="../images/img/image025.png"/></p>
        <div class="blank6"></div>
		...
		<div class="btn">
		<span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign13);doit(sign12);$E('formulatorForm').submit();">结束练习</button></span>
        <span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign11);doit(sign12);">重练</button></span>
         <div class="clear"></div>
          ...
          <!--End div-->
          <form id="formulatorForm" action="formulatorTest.jhtml" target="formulatorFrame"></form>
          <iframe id="formulatorFrame" name="formulatorFrame" style="display:none"></iframe>
           <!--stars div13-->
		<div class="floatBoxs" id=sign13  style='z-index:130;display:none;' > 
		<h3>完成练习</h3>
		<div class="floatBox">
        ...
        <div class="blank6"></div>
        <P><span class="ui-icon-info" style="float: left; margin-right: 0.3em;"/></span>上下标仅限定左侧紧邻的那一个字符，如<img src="../images/img/image032.png" />，一定要牢记！</P>
        <div class="blank6"></div>
       ...
       <P> <span class="ui-icon-info" style="float: left; margin-right: 0.3em;"/></span><strong>注：</strong>进入学习首页后，可在右上角“我的工具箱”查看更多技巧。
        ...
        <div class=" clear"></div>
		<div class="btn">
		<span class="bbs1"><button class="bb1" onmouseout="this.className='bb1';" onmouseover="this.className='bb2';" onClick="javascript:doit(sign01);doit(sign13);">进入学习首页</button></span>
         <div class="clear"></div>
		</div></div></div>
          <!--End div-->
