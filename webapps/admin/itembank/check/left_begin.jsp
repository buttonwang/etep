...
<SCRIPT LANGUAGE="JavaScript">
	var data={};
	data["-1_1"] = "text: 试题查重;url:../duplicate!query.jhtml;target:right";
<c:forEach items="${sessionScope.m_userSubjectGradeRole }" var="usrg" >
	...
	data['${usrg.subject.code}_${grade.code}'] ='text:${grade.name};url:../duplicate!menu.jhtml?subject=${usrg.subject.code}&grade=${grade.code}';	
		</c:forEach>
</c:forEach>
