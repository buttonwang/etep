        ...
        <div class="nTab">
                  ...
                  <tr>
                    <td height="143" valign="top">
                      <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="comm"><img src="../images/info.gif" align="absbottom" />你还有${newwordno}个生词未掌握，请重新学习！</td>
                        </tr>
                      </table>
                      <br />
          ...
          <tr>
                            <td><table cellspacing="0" cellpadding="10" align="center" border="0">
                              <tbody>
                                <tr align="middle">
                                  <td><input onclick="javascript:window.location='freshWordConfig.jhtml'" type="submit" value="  确定  " name="Sub" /></td>
                                </tr>
                              </tbody>
                            </table></td>
                          </tr>
