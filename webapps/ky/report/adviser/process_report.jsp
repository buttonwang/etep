        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <table width="100%" height="264" border="0" cellpadding="0" cellspacing="0" class="listab">
                  <tr>
                    <td valign="top" colspan="2"><c:if test="${userDataVO.sumCorrectItems+userDataVO.sumIncorrectItems>0}"></c:if>                
                    </td>
                  </tr>
                  <tr>
...
已经进行${practiceDoNum}卷训练，${practicePassNum}卷已通过  总  成  绩：${userDataVO.totalScore}分  总正确率：${userDataVO.totalAccuracyRate}% 总掌握度：${userDataVO.totalMasteryRate}% （第${userDataVO.totalMasteryRateOrder}名） </p>                    </td>
                  ...
                  <tr>
                    <td width="373" valign="top"><img src="getImage.jhtml?_zero=${userDataVO.sumZeroStarItems}&_half=${userDataVO.sumHalfStarItems}&_one=${userDataVO.sumOneStarItems}&_two=${userDataVO.sumTwoStarItems}&_three=${userDataVO.sumThreeStarItems}&_four=${userDataVO.sumFourStarItems}&_five=${userDataVO.sumFiveStarItems}&_new=${userDataVO.sumUnfinishedItems}" /><br /></td>
